...
# Computador vence:
if (computador == jogadas[0] and jogador == jogadas[2]) or (computador == jogadas[2] and jogador == jogadas[1]) or (computador == jogadas[1] and jogador == jogadas[0]):
    print('ERA DAS MÁQUINAS! O Computador venceu. \n Computador: {} \n Jogador: {} \n Tente novamente'.format(computador, jogador))
# Jogador Vence:
elif (computador == jogadas[2] and jogador == jogadas[0]) or (computador == jogadas[1] and jogador == jogadas[2]) or (computador == jogadas[0] and jogador == jogadas[1]):
